#!/bin/bash
#SBATCH --job-name=braker3_ep_ath
#SBATCH --output=/home/hoffk83/git/BRAKER4/test_scenarios/scenario_18_braker3_ep_arabidopsis/braker3_ep.log
#SBATCH --error=/home/hoffk83/git/BRAKER4/test_scenarios/scenario_18_braker3_ep_arabidopsis/braker3_ep.err
...
SCENARIO_DIR=/home/hoffk83/git/BRAKER4/test_scenarios/scenario_18_braker3_ep_arabidopsis
...
echo "[INFO] Running braker.pl EP mode (proteins only, skipOptimize)..."
singularity exec \
    -B /home -B /projects \

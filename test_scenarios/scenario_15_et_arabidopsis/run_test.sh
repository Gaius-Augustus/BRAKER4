#!/bin/bash
# Benchmark Scenario 15: ET Mode (A. thaliana, BRAKER1-style)
# BRAKER Mode: ET (genome + RNA-seq via pyVARUS, no proteins)
# Data: Full A. thaliana genome (pre-masked), pyVARUS RNA-seq auto-download
...
echo "============================================"
echo "Benchmark Scenario 15: ET Mode (A. thaliana)"
echo "============================================"
echo ""
echo "Configuration:"
echo "  - Genome: A. thaliana (~135 MB, pre-masked)"
echo "  - RNA-Seq: pyVARUS auto-download (Arabidopsis thaliana)"
echo "  - Proteins: none (ET / BRAKER1-style)"
echo "  - BRAKER Mode: ET"

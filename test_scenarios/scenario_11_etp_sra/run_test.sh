#!/bin/bash
# Test Scenario 11: ETP mode via SRA (O. tauri)
set -euo pipefail
...
echo "=============================================================="
echo "Test Scenario 11: ETP Mode via SRA (O. tauri)"
echo "=============================================================="
echo ""
echo "Configuration:"
...
echo "  - RNA-Seq: SRA accession (SRR33123034, O. tauri)"
echo "  - Pipeline will: Download SRA → Convert to FASTQ → Align"
echo "  - BRAKER Mode: ETP (RNA-Seq + proteins)"
echo "  - Masking: SKIP (using pre-masked genome)"
echo ""
echo "NOTE: Requires internet access and SRA toolkit"
echo "      Demonstrates SRA download with time-saving pre-masked genome"
echo ""

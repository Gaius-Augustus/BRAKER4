#!/bin/bash
#SBATCH --job-name=braker3_et_ath
#SBATCH --output=/home/hoffk83/git/BRAKER4/test_scenarios/scenario_17_braker3_et_arabidopsis/braker3_et.log
#SBATCH --error=/home/hoffk83/git/BRAKER4/test_scenarios/scenario_17_braker3_et_arabidopsis/braker3_et.err
...
SCENARIO_DIR=/home/hoffk83/git/BRAKER4/test_scenarios/scenario_17_braker3_et_arabidopsis
...
if [ ! -f "$BAM" ]; then
    ...
    echo "[ERROR] Wait for S13 pyVARUS job to complete before submitting this job."
    exit 1
fi
...
echo "[INFO] Running braker.pl ET mode (RNA-seq only, skipOptimize)..."
singularity exec \
    -B /home -B /projects \
...
# Extract CDS features (same method as BRAKER4 pipeline)
